...
const  ClientPartnerRouter = express.Router()
ClientPartnerRouter.get('/getOne/:id',  async (req, res) => {
    await PartnerOperations.getOne(req, res)
}),

ClientPartnerRouter.get('/getAllInRange/:lat/:long/:distance', async (req, res)=>{
    try{
...
module.exports = ClientPartnerRouter;
